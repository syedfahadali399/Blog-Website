        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 grid-cols-1">
                          ...
                          <div className="absolute bottom-0 w-full lg:p-11 p-5">
                              <div className="bg-white rounded-lg p-6 block">
                                  <a href="javascript:;" className="flex items-center mb-6">
                                      ...
                                      <h5 className="text-black text-base font-normal leading-6 ml-5">+923120236118</h5>
                                  </a>
                                  <a href="javascript:;" className="flex items-center mb-6">
                                      <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      ...
                                      <h5 className="text-black text-base font-normal leading-6 ml-5">fahadalisyed543@gmail.com</h5>
                                  </a>
              ...
              <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                  <h2 className="text-purple-700 font-manrope text-4xl font-semibold leading-10 mb-11">Send Us A Message</h2>
                  ...
                  <div className="mb-10">
                      ...
                      <div className="flex">
                          <div className="flex items-center mr-11">
                              ...
                              <label form="radio-group-1" className="flex items-center cursor-pointer text-gray-500 text-base font-normal leading-6">
                          ...
                          <div className="flex items-center">
                              ...
                              <label form="radio-group-2" className="flex items-center cursor-pointer text-gray-500 text-base font-normal leading-6">
                  ...
                  <button onClick={feed_back} type="button" className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-lg text-base px-5 py-2.5 text-center me-2 mb-2 ">Send</button>
          </div>
        </div>
        </div>
      </section>
